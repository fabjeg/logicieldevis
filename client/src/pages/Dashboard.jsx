  ...
  return (
    <div className="p-6 space-y-6">
        ...
        {STATUTS.map((s) => {
          ...
          return (
            <div key={s} className="bg-white rounded-xl border border-gray-200 p-5">
              ...
              <p className="mt-3 text-3xl font-bold text-gray-900">{d.count}</p>
              {s !== 'brouillon' && (
                <p className="text-sm text-gray-400 mt-0.5">{euros(d.totalTTC)}</p>
              )}
            </div>
          );
        })}
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        <h2 className="text-sm font-semibold text-gray-700 mb-5">CA mensuel accepté (12 derniers mois)</h2>
