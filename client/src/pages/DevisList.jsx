                  ...
                  <tr key={d._id} className="border-b border-gray-50 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 relative">
                      ...
                      {statutMenu === d._id && (
                        <div
                          ref={menuRef}
                          className="absolute left-2 top-10 z-20 bg-white border border-gray-200 rounded-xl shadow-xl py-1 min-w-36"
                        >
                    ...
                    <td className="px-4 py-3 text-right whitespace-nowrap space-x-2">
                      <button
                        onClick={() => setPreview({ id: d._id, numero: d.numero })}
                      ...
                      <button
                        onClick={() => telechargerPDF(d._id, d.numero)}
                        className="text-gray-400 hover:text-gray-700 text-xs"
